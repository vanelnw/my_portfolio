...
import logo from '../../public/assets/images/vn(1).png'
  ...
  return (
    <div className='w-full shadow-navbarShadow h-20 lg:h-[12vh] sticky top-0 z-50 bg-bodyColor px-4'>
        <div className='max-w-container h-full mx-auto py-1 font-titleFont flex items-center justify-between'>
            ...
            <div className='hidden mdl:flex items-cemter gap-7'>
                <ul className='flex text-[13px] gap-7'>
                  <Link 
                    ...
                    className='flex items-center gap-1 text-[18px] font-medium text-textDark 
            ...
            test-4xl text-textGreen cursor-pointer overflow-hidden group'>
                ...
                >
                  ...
                  >
                   <MdOutlineClose 
                    ...
                    className='absolute top-4 right-4 text-3xl text-textGreen cursor-pointer hover:text-red-400'
                   />
        ...
        <motion.a 
          ...
          href="mailto:vanelnwaba@gmail.com"
